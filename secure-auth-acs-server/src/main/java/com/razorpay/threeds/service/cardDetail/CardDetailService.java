...
public class CardDetailService {
    ...
    public CardDetailResponse getCardDetails(CardDetailsRequest cardDetailsRequest, CardStoreType type) throws ACSException {
    ...
    public void validateCardDetails(CardDetailResponse cardDetailResponse, CardStoreType type) throws ACSException {
        CardDetailFetcherService cardDetailFetcherService = cardDetailFetcherFactory.getCardDetailFetcher(type);
