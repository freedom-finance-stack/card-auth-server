...
public interface ValidationStrategy {
  ...
  <T extends ThreeDSObject, R extends ThreeDSObject> ValidationResponse validateInclusion(
      T input, R input2);
  ...
  <T extends ThreeDSObject, R extends ThreeDSObject> ValidationResponse validateFormat(
      T input, R input2, R input3, R input4);
