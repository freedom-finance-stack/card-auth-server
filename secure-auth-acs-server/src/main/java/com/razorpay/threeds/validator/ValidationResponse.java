...
public class ValidationResponse {
    ...
    public ValidationResponse(boolean invalid, ThreeDSecureErrorCode threeDSecureError, ThreeDSDataElement dataElement) {
        this.threeDSecureError = threeDSecureError;
        this.dataElement = dataElement;
        this.invalid = invalid;
    }

    public ValidationResponse(boolean invalid, ThreeDSecureErrorCode threeDSecureError, ThreeDSDataElement dataElement, String value) {
        this.threeDSecureError = threeDSecureError;
        this.dataElement = dataElement;
        this.invalid = invalid;
        this.value = value;
