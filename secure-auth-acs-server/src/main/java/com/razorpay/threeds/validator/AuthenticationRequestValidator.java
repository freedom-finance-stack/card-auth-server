...
public class AuthenticationRequestValidator implements ThreeDSValidator<AREQ> {
    ...
    protected void validateMandatoryFields(AREQ request) throws ValidationException {
        ...
        Validation.validate(ThreeDSDataElement.SDK_APP_ID.getFieldName(), request.getSdkAppID(), new WhenRule<>(Validation.validateDeviceChannelAndMessageType(ThreeDSDataElement.SDK_APP_ID, request), new NotNullRule<>()), new LengthRule(DataLengthType.VARIABLE, 32));
        Validation.validate(ThreeDSDataElement.SDK_MAX_TIMEOUT.getFieldName(), request.getSdkMaxTimeout(), new WhenRule<>(Validation.validateDeviceChannelAndMessageType(ThreeDSDataElement.SDK_MAX_TIMEOUT, request), new NotNullRule<>()), new LengthRule(DataLengthType.VARIABLE, 5));
        Validation.validate(ThreeDSDataElement.SDK_REFERENCE_NUMBER.getFieldName(), request.getSdkReferenceNumber(), new WhenRule<>(Validation.validateDeviceChannelAndMessageType(ThreeDSDataElement.SDK_REFERENCE_NUMBER, request), new NotNullRule<>()), new LengthRule(DataLengthType.VARIABLE, 32));
        ...
        Validation.validate(ThreeDSDataElement.SDK_TRANS_ID.getFieldName(), request.getSdkTransID(), new WhenRule<String>(Validation.validateDeviceChannelAndMessageType(ThreeDSDataElement.SDK_TRANS_ID, request), new NotNullRule<>()), new LengthRule(DataLengthType.VARIABLE, 36), new isUUIDRule());
