...
public class AuthenticationRequestValidator implements ThreeDSValidator<AREQ> {
  ...
  private void validateMandatoryFields(AREQ request) throws ValidationException {
    ...
    Validation.validate(
        ...
        new WhenRule<>(
            validateDeviceChannelAndMessageCategory(ThreeDSDataElement.THREEDS_COMPIND, request),
            new NotNullRule<>()),
    ...
    Validation.validate(
        ...
        new WhenRule<>(
            validateDeviceChannelAndMessageCategory(ThreeDSDataElement.THREEDS_SERVER_URL, request),
            new NotNullRule<>()),
        new LengthRule(
            DataLengthType.VARIABLE, 2048)); // todo is message version condition needed ?
    Validation.validate(
        ThreeDSDataElement.THREEDS_RI_IND.getFieldName(),
        request.getThreeRIInd(),
        new WhenRule<>(
            validateDeviceChannelAndMessageCategory(ThreeDSDataElement.THREEDS_RI_IND, request),
            new NotNullRule<>()),
    ...
    Validation.validate(
        ...
        new WhenRule<>(
            validateDeviceChannelAndMessageCategory(ThreeDSDataElement.ACQUIRER_BIN, request),
            new NotNullRule<>()),
    ...
    Validation.validate(
        ...
        new WhenRule<>(
            validateDeviceChannelAndMessageCategory(ThreeDSDataElement.BROWSER_LANGUAGE, request),
            new NotNullRule<>()),
        new LengthRule(DataLengthType.VARIABLE, 8));
    Validation.validate(
    ...
    Validation.validate(
        ...
        new WhenRule<>(
            validateDeviceChannelAndMessageCategory(ThreeDSDataElement.BROWSER_TZ, request),
            new NotNullRule<>()),
    ...
    Validation.validate(
        ...
        new WhenRule<>(
            validateDeviceChannelAndMessageCategory(ThreeDSDataElement.BROWSER_USER_AGENT, request),
            new NotNullRule<>()),
        new LengthRule(DataLengthType.VARIABLE, 2048));
    Validation.validate(
        ...
        new WhenRule<>(
            validateDeviceChannelAndMessageCategory(ThreeDSDataElement.ACCT_NUMBER, request),
            new NotNullRule<>()),
    ...
    Validation.validate(
        ...
        new WhenRule<>(
            validateDeviceChannelAndMessageCategory(ThreeDSDataElement.NOTIFICATION_URL, request),
            new NotNullRule<>()),
        new LengthRule(DataLengthType.VARIABLE, 2048));
    ...
    Validation.validate(
        ...
        request.getSdkAppID(),
        new WhenRule<>(
            validateDeviceChannelAndMessageCategory(ThreeDSDataElement.SDK_APP_ID, request),
            new NotNullRule<>()),
        new LengthRule(DataLengthType.VARIABLE, 36));
    Validation.validate(
        ...
        new WhenRule<>(
            validateDeviceChannelAndMessageCategory(ThreeDSDataElement.SDK_MAX_TIMEOUT, request),
            new NotNullRule<>()),
    ...
    Validation.validate(
        ...
        new WhenRule<>(
            validateDeviceChannelAndMessageCategory(ThreeDSDataElement.SDK_EPHEM_PUB_KEY, request),
            new NotNullRule<>()),
        new IsValidRule<>());
    Validation.validate(
        ...
        new WhenRule<>(
            validateDeviceChannelAndMessageCategory(ThreeDSDataElement.SDK_TRANS_ID, request),
            new NotNullRule<>()),
        new LengthRule(DataLengthType.VARIABLE, 36),
        new IsUUIDRule());
    Validation.validate(
        ...
        new WhenRule<>(
            validateDeviceChannelAndMessageCategory(ThreeDSDataElement.DEVICE_INFO, request),
            new NotNullRule<>()),
    ...
    Validation.validate(
        ...
        new WhenRule<>(
            validateDeviceChannelAndMessageCategory(ThreeDSDataElement.DS_TRANS_ID, request),
            new NotNullRule<>()),
  ...
  private void validateConditionalFields(AREQ request) throws ValidationException {
    ...
    Validation.validate(
        ...
        new WhenRule<>(
            validateDeviceChannelAndMessageCategory(ThreeDSDataElement.MERCHANT_NAME, request),
            new NotNullRule<>()),
        new LengthRule(DataLengthType.VARIABLE, 40));
    Validation.validate(
        ...
        new WhenRule<>(
            validateDeviceChannelAndMessageCategory(ThreeDSDataElement.PAY_TOKEN_SOURCE, request)
        ...
        messageExtensionValue -> {
          ...
          if (name != null && name.toString().length() > 64) {
            throw new ValidationException(
                ThreeDSecureErrorCode.INVALID_FORMAT, "Invalid message extension name");
          } else if (id != null && id.toString().length() > 64) {
            throw new ValidationException(
                ThreeDSecureErrorCode.INVALID_FORMAT, "Invalid message extension id");
          }

          LinkedTreeMap<Object, Object> dataMap = (LinkedTreeMap<Object, Object>) meMap.get("data");
          Object text = dataMap.get("text");

          if (text != null && text.toString().length() > 8059) {
            throw new ValidationException(
                ThreeDSecureErrorCode.INVALID_FORMAT, "Invalid message extension data");
          }
        };
  ...
  protected void validateOptionalFields(AREQ request) throws ValidationException {
    ...
    Validation.validate(
        ...
        new IsInRule(ThreeDSDataElement.THREEDS_REQUESTOR_CHALLENGE_IND.getAcceptedValues()));
    Validation.validate(
    ...
    Validation.validate(
        ThreeDSDataElement.HOME_PHONE.getFieldName(), request.getHomePhone(), new IsValidRule<>());
    Validation.validate(
    ...
    Validation.validate(
        ...
        new LengthRule(DataLengthType.VARIABLE, 3));
    Validation.validate(
        ThreeDSDataElement.WORK_PHONE.getFieldName(), request.getWorkPhone(), new IsValidRule<>());
    Validation.validate(
