...
public class ThreeDSConstant {
    ...
    public static final String MESSAGE_TYPE_VREQ = "VReq";//Validation request added for browser call only
    ...
    public static final String ELEMENT_THREEDS_REQUESTOR_AUTH_IND = "threeDSRequestorAuthenticationInd";
    public static final String ELEMENT_THREEDS_REQUESTOR_AUTH_INFO = "threeDSRequestorAuthenticationInfo";
    ...
    public static final String ELEMENT_THREEDS_REQUESTOR_CHALLENGEIND = "threeDSRequestorChallengeInd";
    ...
    public static final String ELEMENT_DEVICE_RENDER_OPTIONS_INTERFACE = "deviceRenderOptions_Interface";
    ...
    public static final String ELEMENT_MERCHANT_RISKINDICATOR_DELIVERY_TIMEFRAME = "deliveryTimeframe";
    public static final String ELEMENT_MERCHANT_RISKINDICATOR_DELIVERY_EMAILADDRESS = "deliveryEmailAddress";
    public static final String ELEMENT_MERCHANT_RISKINDICATOR_REORDER_ITEMS_IND = "reorderItemsInd";
    public static final String ELEMENT_MERCHANT_RISKINDICATOR_PREORDER_PURCHASE_IND = "preOrderPurchaseInd";
    ...
    public static final String ELEMENT_MESSAGE_EXTENSION_CRITICALITY_INDICATOR = "messageExtension_criticalityIndicator";
    ...
    public static final String ELEMENT_THREEDS_REQUESTOR_PRIOR_AUTHENTICATION_INFO = "threeDSRequestorPriorAuthenticationInfo";
    ...
    public static final String ELEMENT_THREEDS_REQUESTOR_DEC_MAX_TIME="threeDSRequestorDecMaxTime";
