...
public class AuthenticationRequestValidator implements ThreeDSValidator<AREQ> {
    ...
    private void validateMandatoryFields(AREQ request) throws ACSValidationException {
        ...
        try {
            ...
            Validation.validate(
                    ...
                    when(
                            validateDeviceChannelAndMessageCategory(
                                    ThreeDSDataElement.DS_URL, request),
                            notNull()),
                    lengthValidator(LengthValidator.DataLengthType.VARIABLE, 2048));
    ...
    private void validateConditionalFields(AREQ request) throws ACSValidationException {
        ...
        try {
            Validation.validate(
                    ...
                    when(
                            validateDeviceChannelAndMessageCategory(
                                    ThreeDSDataElement.MCC, request),
                            notNull()),
            ...
            Validation.validate(
                    ...
                    when(
                            validateDeviceChannelAndMessageCategory(
                                            ThreeDSDataElement.THREEDS_REQUESTOR_DEC_MAX_TIME,
                                            request)
            ...
            boolean purchaseElementsWhenRule =
                    validateDeviceChannel(ThreeDSDataElement.PURCHASE_AMOUNT, request)
                            && (request.getMessageCategory()
                                            .equals(MessageCategory.PA.getCategory())
                                    || (request.getMessageCategory()
    ...
    protected void validateOptionalFields(AREQ request) throws ACSValidationException {
