 ...
 */
public class UiConfigException extends ACSException {

    private static final long serialVersionUID = 1L;

    public UiConfigException(InternalErrorCode internalErrorCode, String message, Throwable cause) {
        super(internalErrorCode, message, cause);
    }

    public UiConfigException(InternalErrorCode internalErrorCode, String message) {
