...
class ResultResponseValidatorTest {
    ...
    @InjectMocks private ResultResponseValidator resultResponseValidator;
    ...
    void validateRequest_NullIncomingRRes() {
        ...
        assertThrows(
                ...
                () -> resultResponseValidator.validateRequest(null, validRReq));
    }
    ...
    void validateRequest_NullRReq() {
        ...
        assertThrows(
                ACSValidationException.class,
                () -> resultResponseValidator.validateRequest(validRRes, null));
    }
    ...
    void validateRequest_Invalid(
            String name,
            HashMap<String, Object> rreqDataMap,
            HashMap<String, Object> rresDataMap,
        ...
        ACSValidationException exception =
                assertThrows(
                        ACSValidationException.class,
                        () -> resultResponseValidator.validateRequest(invalidRRes, validRReq));
        ...
        return Stream.of(
                ...
                Arguments.of(
                        ...
                        new ACSValidationException(
                                ...
                                "Invalid value for messageVersion")),
                Arguments.of(
                        "ThreeDSServerTransID empty",
                        new HashMap<>() {},
                        new HashMap<>() {
                            {
                                put("threeDSServerTransID", "");
                            }
                        },
                        new ACSValidationException(
                                ThreeDSecureErrorCode.REQUIRED_DATA_ELEMENT_MISSING,
                ...
                Arguments.of(
                        "ThreeDSServerTransID not matching",
                        new HashMap<>() {
                            {
                                put("threeDSServerTransID", "ThreeDSServerTransID1");
                            }
                        },
                        new HashMap<>() {
                            {
                                put("threeDSServerTransID", "ThreeDSServerTransID12");
                            }
                        },
                        new ACSValidationException(
                ...
                Arguments.of(
                        "acsTransID not matching",
                        new HashMap<>() {
                            {
                                put("acsTransID", "acsTransID1");
                            }
                        },
                        new HashMap<>() {
                            {
                                put("acsTransID", "acsTransID12");
                            }
                        },
                        new ACSValidationException(
                                ThreeDSecureErrorCode.TRANSACTION_ID_NOT_RECOGNISED,
                ...
                Arguments.of(
                        ...
                        new ACSValidationException(
                                ThreeDSecureErrorCode.REQUIRED_DATA_ELEMENT_MISSING,
                                "Invalid value for dsTransID")),
                Arguments.of(
                        "dsTransID not matching",
                        new HashMap<>() {
                            {
                                put("dsTransID", "dsTransID1");
                            }
                        },
                        new HashMap<>() {
                            {
                                put("dsTransID", "dsTransID12");
                            }
                        },
                        new ACSValidationException(
                                ThreeDSecureErrorCode.TRANSACTION_ID_NOT_RECOGNISED,
                                "Invalid value for dsTransID")),
                Arguments.of(
                        "resultsStatus incorrect",
                        new HashMap<>() {},
                        new HashMap<>() {
                            {
                                put("resultsStatus", "InvalidMessageType");
                            }
                        },
                        new ACSValidationException(
                                ThreeDSecureErrorCode.INVALID_FORMAT_VALUE,
                                "Invalid value for resultsStatus")),
                Arguments.of(
                        "resultsStatus empty",
                        new HashMap<>() {},
                        new HashMap<>() {
