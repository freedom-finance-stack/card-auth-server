...
INSERT INTO `signer_detail` VALUES ('I1', '1', 'card-auth-server/docs/certs/acs_keystore', 'password', 'acs', 'acs', 'root', 'inter', NOW(), 'dev-user', NOW(), 'dev-user', NULL, NULL);
INSERT INTO `signer_detail` VALUES ('I1', '2', 'card-auth-server/docs/certs/acs_keystore', 'password', 'acs', 'acs', 'root', 'inter', NOW(), 'dev-user', NOW(), 'dev-user', NULL, NULL);
UNLOCK TABLES;